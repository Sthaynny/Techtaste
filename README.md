...
<p align="center">
  ...
  <img alt="Languages" src="https://img.shields.io/github/languages/count/Sthaynny/Techtaste?color=%235963C5" />
  <img alt="lastcommit" src="https://img.shields.io/github/last-commit/Sthaynny/Techtaste?color=%235761C3" />
  <img alt="License" src="https://img.shields.io/github/license/Sthaynny/Techtaste?color=%235E69D7" />
  <img alt="Issues" src="https://img.shields.io/github/issues/Sthaynny/Techtaste?color=%235965E0">
...
```bash
# Clone Repositorio
$ git clone https://github.com/Sthaynny/Techtaste.git
...
Cria um issue <a href="https://github.com/Sthaynny/Techtaste/issues">nova issue</a>, será uma honra poder ajudá-lo a resolver e melhorar ainda mais nosso aplicativo.
...
- Para mais informações acesse o [Guia de contribuição](https://github.com/Sthaynny/Techtaste/blob/main/.github/contributing.md)
